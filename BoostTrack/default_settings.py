...
def get_detector_path_and_im_size(args) -> Tuple[str, Tuple[int, int]]:
    if args.dataset == "mot17":
        ...
        detector_path = "external/weights/bytetrack_x_mot20.tar"
        size = (896, 1600)
        # raise RuntimeError("Need to update paths for detector for extra datasets.")   # JUST FOR THE SAKE OF TRYING,
    return detector_path, size                                                          # WE MAY NEED TO TRAIN OUR OWN DETECTOR
